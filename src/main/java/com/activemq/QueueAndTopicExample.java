...
//        Thread.sleep(2000);
    ...
    public static class HelloWorldPublisher implements Runnable {
        public void run() {
            try {
                // Create a ConnectionFactory
                ActiveMQConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://localhost:61616");
    ...
    public static class HelloWorldSubscriber implements Runnable, ExceptionListener {
        public void run() {
            try {
